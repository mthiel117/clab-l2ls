...
| --------- | --------------- | ------------ | --------- |
| SPINES | Vlan4094 | 10.0.0.0 | Port-Channel311 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1/1 | LEAF1_Ethernet54/1 | *trunk | *10,20,30 | *- | *- | 11 |
| Ethernet2/1 | LEAF2_Ethernet54/1 | *trunk | *10,20,30 | *- | *- | 11 |
| Ethernet3/1 | LEAF3_Ethernet54/1 | *trunk | *20 | *- | *- | 31 |
| Ethernet4/1 | LEAF4_Ethernet54/1 | *trunk | *20 | *- | *- | 31 |
| Ethernet5/1 | LEAF5_Ethernet30/1 | *trunk | *30 | *- | *- | 51 |
| Ethernet6/1 | LEAF6_Ethernet30/1 | *trunk | *30 | *- | *- | 51 |
| Ethernet31/1 | MLAG_PEER_spine1_Ethernet31/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 311 |
| Ethernet32/1 | MLAG_PEER_spine1_Ethernet32/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 311 |
...
interface Ethernet1/1
   description LEAF1_Ethernet54/1
   no shutdown
   channel-group 11 mode active
!
interface Ethernet2/1
   description LEAF2_Ethernet54/1
   no shutdown
   channel-group 11 mode active
!
interface Ethernet3/1
   description LEAF3_Ethernet54/1
   no shutdown
   channel-group 31 mode active
!
interface Ethernet4/1
   description LEAF4_Ethernet54/1
   no shutdown
   channel-group 31 mode active
!
interface Ethernet5/1
   description LEAF5_Ethernet30/1
   no shutdown
   channel-group 51 mode active
!
interface Ethernet6/1
   description LEAF6_Ethernet30/1
   no shutdown
   channel-group 51 mode active
!
interface Ethernet31/1
   description MLAG_PEER_spine1_Ethernet31/1
   no shutdown
   channel-group 311 mode active
!
interface Ethernet32/1
   description MLAG_PEER_spine1_Ethernet32/1
   no shutdown
   channel-group 311 mode active
```
...
| Port-Channel311 | MLAG_PEER_spine1_Po311 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel311
   description MLAG_PEER_spine1_Po311
   no shutdown
   switchport
