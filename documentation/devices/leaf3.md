...
| --------- | --------------- | ------------ | --------- |
| RACK2 | Vlan4094 | 10.0.0.9 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet53/1 | SPINE1_Ethernet3/1 | *trunk | *20 | *- | *- | 531 |
| Ethernet54/1 | SPINE2_Ethernet3/1 | *trunk | *20 | *- | *- | 531 |
| Ethernet55/1 | MLAG_PEER_leaf4_Ethernet55/1 | *trunk | *2-4094 | *- | *['MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_leaf4_Ethernet56/1 | *trunk | *2-4094 | *- | *['MLAG'] | 551 |
...
interface Ethernet55/1
   description MLAG_PEER_leaf4_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_leaf4_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| Port-Channel551 | MLAG_PEER_leaf4_Po551 | switched | trunk | 2-4094 | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_leaf4_Po551
   no shutdown
   switchport
